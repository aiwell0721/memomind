...
|| **12** | **[知识图谱可视化详细设计](./04-detailed-design/12-知识图谱可视化详细设计.md)** | **ECharts 图谱 + 后端分析注解（2026-08）** |
|| **13** | **[分层归档与智能触发详细设计](./04-detailed-design/13-分层归档详细设计.md)** | **分层归档 + 搜索降权 + 阈值触发** |
...
| **07** | **[技能借鉴评估-ontology与self-improving](./05-development-plan/07-技能借鉴评估-ontology与self-improving.md)** | **ontology + self-improving 借鉴评估（2026-08）** |
